<?php
/**
 * Plugin Name: FREIZEIT Events CPT
 * Description: Generate Events custom post type.
...
function fz_create_events_custom_post_type() {
	...
	$labels = array(
		...
		'all_items'             => __( 'Minden esemény', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Események', 'text_domain' ),
		'labels'                => $labels,
...
add_action( 'init', 'fz_create_events_custom_post_type', 0 );